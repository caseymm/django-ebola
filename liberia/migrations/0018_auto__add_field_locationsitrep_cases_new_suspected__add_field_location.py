...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'LocationSitRep.cases_new_suspected'
        db.add_column(u'liberia_locationsitrep', 'cases_new_suspected',
                      self.gf('django.db.models.fields.IntegerField')(max_length=50, null=True, blank=True),
                      keep_default=False)

        # Adding field 'LocationSitRep.cases_new_probable'
        db.add_column(u'liberia_locationsitrep', 'cases_new_probable',
                      self.gf('django.db.models.fields.IntegerField')(max_length=50, null=True, blank=True),
                      keep_default=False)

        # Adding field 'LocationSitRep.cases_new_confirmed'
        db.add_column(u'liberia_locationsitrep', 'cases_new_confirmed',
                      self.gf('django.db.models.fields.IntegerField')(max_length=50, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'LocationSitRep.cases_new_suspected'
        db.delete_column(u'liberia_locationsitrep', 'cases_new_suspected')

        # Deleting field 'LocationSitRep.cases_new_probable'
        db.delete_column(u'liberia_locationsitrep', 'cases_new_probable')

        # Deleting field 'LocationSitRep.cases_new_confirmed'
        db.delete_column(u'liberia_locationsitrep', 'cases_new_confirmed')
