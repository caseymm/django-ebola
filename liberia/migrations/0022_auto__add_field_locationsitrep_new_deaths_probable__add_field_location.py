...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'LocationSitRep.new_deaths_probable'
        db.add_column(u'liberia_locationsitrep', 'new_deaths_probable',
                      self.gf('django.db.models.fields.IntegerField')(max_length=50, null=True, blank=True),
                      keep_default=False)

        # Adding field 'LocationSitRep.new_deaths_suspected'
        db.add_column(u'liberia_locationsitrep', 'new_deaths_suspected',
                      self.gf('django.db.models.fields.IntegerField')(max_length=50, null=True, blank=True),
                      keep_default=False)

        # Adding field 'LocationSitRep.new_deaths_confirmed'
        db.add_column(u'liberia_locationsitrep', 'new_deaths_confirmed',
                      self.gf('django.db.models.fields.IntegerField')(max_length=50, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'LocationSitRep.new_deaths_probable'
        db.delete_column(u'liberia_locationsitrep', 'new_deaths_probable')

        # Deleting field 'LocationSitRep.new_deaths_suspected'
        db.delete_column(u'liberia_locationsitrep', 'new_deaths_suspected')

        # Deleting field 'LocationSitRep.new_deaths_confirmed'
        db.delete_column(u'liberia_locationsitrep', 'new_deaths_confirmed')
