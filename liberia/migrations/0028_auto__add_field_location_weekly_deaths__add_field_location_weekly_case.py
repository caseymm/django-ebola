...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Location.weekly_deaths'
        db.add_column(u'liberia_location', 'weekly_deaths',
                      self.gf('django.db.models.fields.TextField')(default='', blank=True),
                      keep_default=False)

        # Adding field 'Location.weekly_cases'
        db.add_column(u'liberia_location', 'weekly_cases',
                      self.gf('django.db.models.fields.TextField')(default='', blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Location.weekly_deaths'
        db.delete_column(u'liberia_location', 'weekly_deaths')

        # Deleting field 'Location.weekly_cases'
        db.delete_column(u'liberia_location', 'weekly_cases')
