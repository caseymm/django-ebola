...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'LocationSitRep.date'
        db.add_column(u'liberia_locationsitrep', 'date',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=100, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'LocationSitRep.date'
        db.delete_column(u'liberia_locationsitrep', 'date')
