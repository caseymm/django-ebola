...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'LocationSitRep.cases_new_total'
        db.add_column(u'liberia_locationsitrep', 'cases_new_total',
                      self.gf('django.db.models.fields.IntegerField')(max_length=50, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'LocationSitRep.cases_new_total'
        db.delete_column(u'liberia_locationsitrep', 'cases_new_total')
