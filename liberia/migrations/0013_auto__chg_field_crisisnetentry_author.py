...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'CrisisNetEntry.author'
        db.alter_column(u'liberia_crisisnetentry', 'author_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['liberia.Author'], null=True))

    def backwards(self, orm):

        # Changing field 'CrisisNetEntry.author'
        db.alter_column(u'liberia_crisisnetentry', 'author_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['liberia.Location'], null=True))
