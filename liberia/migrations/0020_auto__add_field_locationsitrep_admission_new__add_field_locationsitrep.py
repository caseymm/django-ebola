...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'LocationSitRep.admission_new'
        db.add_column(u'liberia_locationsitrep', 'admission_new',
                      self.gf('django.db.models.fields.IntegerField')(max_length=50, null=True, blank=True),
                      keep_default=False)

        # Adding field 'LocationSitRep.in_treatment'
        db.add_column(u'liberia_locationsitrep', 'in_treatment',
                      self.gf('django.db.models.fields.IntegerField')(max_length=50, null=True, blank=True),
                      keep_default=False)

        # Adding field 'LocationSitRep.total_discharges'
        db.add_column(u'liberia_locationsitrep', 'total_discharges',
                      self.gf('django.db.models.fields.IntegerField')(max_length=50, null=True, blank=True),
                      keep_default=False)

        # Adding field 'LocationSitRep.admission_cum'
        db.add_column(u'liberia_locationsitrep', 'admission_cum',
                      self.gf('django.db.models.fields.IntegerField')(max_length=50, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'LocationSitRep.admission_new'
        db.delete_column(u'liberia_locationsitrep', 'admission_new')

        # Deleting field 'LocationSitRep.in_treatment'
        db.delete_column(u'liberia_locationsitrep', 'in_treatment')

        # Deleting field 'LocationSitRep.total_discharges'
        db.delete_column(u'liberia_locationsitrep', 'total_discharges')

        # Deleting field 'LocationSitRep.admission_cum'
        db.delete_column(u'liberia_locationsitrep', 'admission_cum')
