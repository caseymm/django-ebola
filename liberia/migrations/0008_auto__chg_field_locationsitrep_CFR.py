...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'LocationSitRep.CFR'
        db.alter_column(u'liberia_locationsitrep', 'CFR', self.gf('django.db.models.fields.CharField')(max_length=100, null=True))

    def backwards(self, orm):

        # Changing field 'LocationSitRep.CFR'
        db.alter_column(u'liberia_locationsitrep', 'CFR', self.gf('django.db.models.fields.CharField')(default='', max_length=100))
