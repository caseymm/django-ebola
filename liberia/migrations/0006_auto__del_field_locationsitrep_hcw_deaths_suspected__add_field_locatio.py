...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'LocationSitRep.hcw_deaths_suspected'
        db.delete_column(u'liberia_locationsitrep', 'hcw_deaths_suspected')

        # Adding field 'LocationSitRep.hcw_deaths_cum'
        db.add_column(u'liberia_locationsitrep', 'hcw_deaths_cum',
                      self.gf('django.db.models.fields.IntegerField')(max_length=50, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'LocationSitRep.hcw_deaths_suspected'
        db.add_column(u'liberia_locationsitrep', 'hcw_deaths_suspected',
                      self.gf('django.db.models.fields.IntegerField')(max_length=50, null=True, blank=True),
                      keep_default=False)

        # Deleting field 'LocationSitRep.hcw_deaths_cum'
        db.delete_column(u'liberia_locationsitrep', 'hcw_deaths_cum')
