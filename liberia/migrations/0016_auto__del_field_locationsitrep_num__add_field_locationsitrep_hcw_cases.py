...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'LocationSitRep.num'
        db.delete_column(u'liberia_locationsitrep', 'num')

        # Adding field 'LocationSitRep.hcw_cases_new'
        db.add_column(u'liberia_locationsitrep', 'hcw_cases_new',
                      self.gf('django.db.models.fields.IntegerField')(max_length=50, null=True, blank=True),
                      keep_default=False)

        # Adding field 'LocationSitRep.hcw_deaths_new'
        db.add_column(u'liberia_locationsitrep', 'hcw_deaths_new',
                      self.gf('django.db.models.fields.IntegerField')(max_length=50, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'LocationSitRep.num'
        db.add_column(u'liberia_locationsitrep', 'num',
                      self.gf('django.db.models.fields.IntegerField')(max_length=50, null=True, blank=True),
                      keep_default=False)

        # Deleting field 'LocationSitRep.hcw_cases_new'
        db.delete_column(u'liberia_locationsitrep', 'hcw_cases_new')

        # Deleting field 'LocationSitRep.hcw_deaths_new'
        db.delete_column(u'liberia_locationsitrep', 'hcw_deaths_new')
