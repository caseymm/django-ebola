...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'SitRep.formatted_date'
        db.add_column(u'liberia_sitrep', 'formatted_date',
                      self.gf('django.db.models.fields.DateField')(null=True),
                      keep_default=False)

        # Adding field 'LocationSitRep.formatted_date'
        db.add_column(u'liberia_locationsitrep', 'formatted_date',
                      self.gf('django.db.models.fields.DateField')(null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'SitRep.formatted_date'
        db.delete_column(u'liberia_sitrep', 'formatted_date')

        # Deleting field 'LocationSitRep.formatted_date'
        db.delete_column(u'liberia_locationsitrep', 'formatted_date')
