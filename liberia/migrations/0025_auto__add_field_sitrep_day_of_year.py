...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'SitRep.day_of_year'
        db.add_column(u'liberia_sitrep', 'day_of_year',
                      self.gf('django.db.models.fields.IntegerField')(max_length=50, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'SitRep.day_of_year'
        db.delete_column(u'liberia_sitrep', 'day_of_year')
