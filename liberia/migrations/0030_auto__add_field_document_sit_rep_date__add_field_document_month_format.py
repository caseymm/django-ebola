...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Document.sit_rep_date'
        db.add_column(u'liberia_document', 'sit_rep_date',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=200, blank=True),
                      keep_default=False)

        # Adding field 'Document.month_format'
        db.add_column(u'liberia_document', 'month_format',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=200, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Document.sit_rep_date'
        db.delete_column(u'liberia_document', 'sit_rep_date')

        # Deleting field 'Document.month_format'
        db.delete_column(u'liberia_document', 'month_format')
