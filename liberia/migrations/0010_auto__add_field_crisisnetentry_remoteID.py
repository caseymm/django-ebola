...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'CrisisNetEntry.remoteID'
        db.add_column(u'liberia_crisisnetentry', 'remoteID',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=500, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'CrisisNetEntry.remoteID'
        db.delete_column(u'liberia_crisisnetentry', 'remoteID')
