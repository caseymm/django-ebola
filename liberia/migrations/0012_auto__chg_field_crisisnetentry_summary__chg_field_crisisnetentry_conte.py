...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'CrisisNetEntry.summary'
        db.alter_column(u'liberia_crisisnetentry', 'summary', self.gf('django.db.models.fields.TextField')())

        # Changing field 'CrisisNetEntry.content'
        db.alter_column(u'liberia_crisisnetentry', 'content', self.gf('django.db.models.fields.TextField')())

    def backwards(self, orm):

        # Changing field 'CrisisNetEntry.summary'
        db.alter_column(u'liberia_crisisnetentry', 'summary', self.gf('django.db.models.fields.CharField')(max_length=500))

        # Changing field 'CrisisNetEntry.content'
        db.alter_column(u'liberia_crisisnetentry', 'content', self.gf('django.db.models.fields.CharField')(max_length=500))
