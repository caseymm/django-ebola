...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'LocationSitRep.total_probable_deaths'
        db.delete_column(u'liberia_locationsitrep', 'total_probable_deaths')

        # Adding field 'LocationSitRep.total_deaths_probable'
        db.add_column(u'liberia_locationsitrep', 'total_deaths_probable',
                      self.gf('django.db.models.fields.IntegerField')(max_length=50, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'LocationSitRep.total_probable_deaths'
        db.add_column(u'liberia_locationsitrep', 'total_probable_deaths',
                      self.gf('django.db.models.fields.IntegerField')(max_length=50, null=True, blank=True),
                      keep_default=False)

        # Deleting field 'LocationSitRep.total_deaths_probable'
        db.delete_column(u'liberia_locationsitrep', 'total_deaths_probable')
