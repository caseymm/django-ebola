...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'liberia_location', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=100, blank=True)),
        ))
        db.send_create_signal(u'liberia', ['Location'])

        # Adding model 'LocationSitRep'
        db.create_table(u'liberia_locationsitrep', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('sit_rep', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['liberia.SitRep'], null=True, blank=True)),
            ('location', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['liberia.Location'], null=True, blank=True)),
            ('date_span', self.gf('django.db.models.fields.CharField')(max_length=100, blank=True)),
            ('total_probable_deaths', self.gf('django.db.models.fields.IntegerField')(max_length=50, null=True, blank=True)),
            ('cases_cum_suspected', self.gf('django.db.models.fields.IntegerField')(max_length=50, null=True, blank=True)),
            ('cases_cum_probable', self.gf('django.db.models.fields.IntegerField')(max_length=50, null=True, blank=True)),
            ('cases_cum_confirmed', self.gf('django.db.models.fields.IntegerField')(max_length=50, null=True, blank=True)),
            ('cases_cum', self.gf('django.db.models.fields.IntegerField')(max_length=50, null=True, blank=True)),
            ...
            ('deaths', self.gf('django.db.models.fields.IntegerField')(max_length=50, null=True, blank=True)),
            ('hc_workers', self.gf('django.db.models.fields.IntegerField')(max_length=50, null=True, blank=True)),
            ('hcw_cases_cum', self.gf('django.db.models.fields.IntegerField')(max_length=50, null=True, blank=True)),
            ('hcw_deaths_suspected', self.gf('django.db.models.fields.IntegerField')(max_length=50, null=True, blank=True)),
            ('CFR', self.gf('django.db.models.fields.CharField')(max_length=100, blank=True)),
        ))
        db.send_create_signal(u'liberia', ['LocationSitRep'])

        # Adding model 'SitRep'
        db.create_table(u'liberia_sitrep', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('date_span', self.gf('django.db.models.fields.CharField')(max_length=100, blank=True)),
        ))
        db.send_create_signal(u'liberia', ['SitRep'])


    def backwards(self, orm):
        # Deleting model 'Location'
        db.delete_table(u'liberia_location')

        # Deleting model 'LocationSitRep'
        db.delete_table(u'liberia_locationsitrep')

        # Deleting model 'SitRep'
        db.delete_table(u'liberia_sitrep')
