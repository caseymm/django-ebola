...
class Command(BaseCommand):
    ...
    def handle(self, *args, **options):
        with open('data/sr0826_hcw.csv', 'rU') as csvfile:
            csvfile.readline()
            ...
            for row in fp:
                ...
                new_loc_sr.hcw_cases_new = row[1]
                new_loc_sr.hcw_cases_cum = row[2]
                new_loc_sr.hcw_deaths_new = row[3]
                new_loc_sr.hcw_deaths_cum = row[4]
                new_loc_sr.save()
