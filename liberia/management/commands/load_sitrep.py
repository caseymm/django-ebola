...
class Command(BaseCommand):
    ...
    def handle(self, *args, **options):
        ...
        #     #Need to fix this
        #     new_loc_sr.total_discharges = loc_dict[i].get("Total discharges on 2nd Sept. 2014")
        #     new_loc_sr.hcw_deaths_new = loc_dict[i].get("Newly Reported deaths in HCW on 2nd Sept. 2014")
        #     new_loc_sr.total_deaths_confirmed = loc_dict[i].get("Total death/s in confirmed cases")
        #     new_loc_sr.deaths = loc_dict[i].get("Newly reported deaths 2nd Sept. 2014")
        ...
        #     new_loc_sr.admission_new = loc_dict[i].get("New Admission on Sept. 2 2014")
        ...
        #     new_loc_sr.hcw_cases_new = loc_dict[i].get("Newly Reported Cases in HCW on 2nd Sept. 2014")
